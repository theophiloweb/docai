...
BEGIN
    ...
    SELECT id INTO extrato_jan_id FROM "Documents" WHERE user_id = client_id AND title = 'Extrato Bancário - Janeiro 2025';
    SELECT id INTO extrato_fev_id FROM "Documents" WHERE user_id = client_id AND title = 'Extrato Bancário - Fevereiro 2025';
    SELECT id INTO extrato_mar_id FROM "Documents" WHERE user_id = client_id AND title = 'Extrato Bancário - Março 2025';
    SELECT id INTO extrato_abr_id FROM "Documents" WHERE user_id = client_id AND title = 'Extrato Bancário - Abril 2025';
    SELECT id INTO extrato_mai_id FROM "Documents" WHERE user_id = client_id AND title = 'Extrato Bancário - Maio 2025';
    
    SELECT id INTO fatura_jan_id FROM "Documents" WHERE user_id = client_id AND title = 'Fatura Cartão - Janeiro 2025';
    SELECT id INTO fatura_fev_id FROM "Documents" WHERE user_id = client_id AND title = 'Fatura Cartão - Fevereiro 2025';
    SELECT id INTO fatura_mar_id FROM "Documents" WHERE user_id = client_id AND title = 'Fatura Cartão - Março 2025';
    SELECT id INTO fatura_abr_id FROM "Documents" WHERE user_id = client_id AND title = 'Fatura Cartão - Abril 2025';
    SELECT id INTO fatura_mai_id FROM "Documents" WHERE user_id = client_id AND title = 'Fatura Cartão - Maio 2025';
    
    SELECT id INTO recibo_jan_id FROM "Documents" WHERE user_id = client_id AND title = 'Recibo Aluguel - Janeiro 2025';
    SELECT id INTO recibo_fev_id FROM "Documents" WHERE user_id = client_id AND title = 'Recibo Aluguel - Fevereiro 2025';
    SELECT id INTO recibo_mar_id FROM "Documents" WHERE user_id = client_id AND title = 'Recibo Aluguel - Março 2025';
    SELECT id INTO recibo_abr_id FROM "Documents" WHERE user_id = client_id AND title = 'Recibo Aluguel - Abril 2025';
    SELECT id INTO recibo_mai_id FROM "Documents" WHERE user_id = client_id AND title = 'Recibo Aluguel - Maio 2025';
    ...
    IF extrato_jan_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_jan_id, client_id, 'extrato_bancario'::enum_FinancialRecords_record_type,
    ...
    IF extrato_fev_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_fev_id, client_id, 'extrato_bancario'::enum_FinancialRecords_record_type,
    ...
    IF extrato_mar_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_mar_id, client_id, 'extrato_bancario'::enum_FinancialRecords_record_type,
    ...
    IF extrato_abr_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_abr_id, client_id, 'extrato_bancario'::enum_FinancialRecords_record_type,
    ...
    IF extrato_mai_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_mai_id, client_id, 'extrato_bancario'::enum_FinancialRecords_record_type,
    ...
    IF recibo_jan_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_jan_id, client_id, 'recibo'::enum_FinancialRecords_record_type,
    ...
    IF recibo_fev_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_fev_id, client_id, 'recibo'::enum_FinancialRecords_record_type,
    ...
    IF recibo_mar_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_mar_id, client_id, 'recibo'::enum_FinancialRecords_record_type,
    ...
    IF recibo_abr_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_abr_id, client_id, 'recibo'::enum_FinancialRecords_record_type,
    ...
    IF recibo_mai_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_mai_id, client_id, 'recibo'::enum_FinancialRecords_record_type,
    ...
    IF fatura_jan_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_jan_id, client_id, 'fatura'::enum_FinancialRecords_record_type,
    ...
    IF fatura_fev_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_fev_id, client_id, 'fatura'::enum_FinancialRecords_record_type,
    ...
    IF fatura_mar_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_mar_id, client_id, 'fatura'::enum_FinancialRecords_record_type,
    ...
    IF fatura_abr_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_abr_id, client_id, 'fatura'::enum_FinancialRecords_record_type,
    ...
    IF fatura_mai_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_mai_id, client_id, 'fatura'::enum_FinancialRecords_record_type,
