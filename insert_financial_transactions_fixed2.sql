...
BEGIN
    ...
    IF extrato_jan_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_jan_id, client_id, 'extrato_bancario',
    ...
    IF extrato_fev_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_fev_id, client_id, 'extrato_bancario',
    ...
    IF extrato_mar_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_mar_id, client_id, 'extrato_bancario',
    ...
    IF extrato_abr_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_abr_id, client_id, 'extrato_bancario',
    ...
    IF extrato_mai_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), extrato_mai_id, client_id, 'extrato_bancario',
    ...
    IF recibo_jan_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_jan_id, client_id, 'recibo',
    ...
    IF recibo_fev_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_fev_id, client_id, 'recibo',
    ...
    IF recibo_mar_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_mar_id, client_id, 'recibo',
    ...
    IF recibo_abr_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_abr_id, client_id, 'recibo',
    ...
    IF recibo_mai_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), recibo_mai_id, client_id, 'recibo',
    ...
    IF fatura_jan_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_jan_id, client_id, 'fatura',
    ...
    IF fatura_fev_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_fev_id, client_id, 'fatura',
    ...
    IF fatura_mar_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_mar_id, client_id, 'fatura',
    ...
    IF fatura_abr_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_abr_id, client_id, 'fatura',
    ...
    IF fatura_mai_id IS NOT NULL THEN
        INSERT INTO "FinancialRecords" (
            ...
            gen_random_uuid(), fatura_mai_id, client_id, 'fatura',
